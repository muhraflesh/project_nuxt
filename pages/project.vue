                    ...
                    <div class="tile is-ancestor has-text-centered">
                        <div class="tile is-parent ">
                            <article class="tile is-child box has-background-info">
                                <p class="title has-text-white">50</p>
                                <p class="subtitle has-text-white">Tasks</p>
                            </article>
                        </div>
                        <div class="tile is-parent ">
                            <article class="tile is-child box has-background-warning">
                                <p class="title has-text-white">20</p>
                                <p class="subtitle has-text-white">Akan Dikerjakan</p>
                            </article>
                        </div>
                        <div class="tile is-parent ">
                            <article class="tile is-child box has-background-danger">
                                <p class="title has-text-white">5</p>
                                <p class="subtitle has-text-white">Dikejar Dateline</p>
                            </article>
                        </div>
                        <div class="tile is-parent">
                            <article class="tile is-child box has-background-success">
                                <p class="title has-text-white">25</p>
                                <p class="subtitle has-text-white">Done</p>
                            </article>
                        </div>
                    </div>
                </section>
